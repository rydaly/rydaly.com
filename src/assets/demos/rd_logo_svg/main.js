...
showLogo = function() {
  ...
  var logo = document.getElementsByClassName( 'logo' ),
      logo2 = document.getElementsByClassName( 'logo2' ),
      bl = document.getElementsByClassName( 'bl' ),
      br = document.getElementsByClassName( 'br' ),
      ul = document.getElementsByClassName( 'ul' ),
      ur = document.getElementsByClassName( 'ur' ),
      circ = document.getElementsByClassName( 'circ' ),
  ...
  function logo01() {
    ...
    tl.set( ul, { x:0, y:55 } );
    tl.set( ur, { x:0, y:54 } );
    tl.set( circ, { scale:0, transformOrigin:"center center" } );
